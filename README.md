# Проект по автоматизации тестирования infinnity.ru
<a href="https://www.infinnity.ru/"><img width="50%" title="Infinnity Solutions" src="images/logo/infinnity solutions.jpg"></a>
...
- Проверка работы формы обратной связи (c PageObjects)
- Проверка работы станицы 'Проекты' (c PageObjects)
- Проверка работы станицы 'InfinniPlatform' (работоспособности сайта)
- Проверка наличия Title на странице
- Проверка наличия ошибок в консоли

## :point_up_2: Сборка в Jenkins
### <a target="_blank" href="https://jenkins.autotests.cloud/job/Zoloft-Infinnity-Tests/">Сборка в Jenkins</a>
<p align="center">
